...
public static class XYZVectorExtensions
{
  ...
  public static bool AreVectorsParallel( this XYZ firstVector,
    XYZ secondVector )
  {
    return firstVector.IsAlmostEqualTo( secondVector,
  ...
  public static bool IsParallel( this XYZ firstVector,
    XYZ secondVector )
  {
    return AlignStraightVector( firstVector )
  ...
  public static bool AreDirectionsPerpendicular2D( this XYZ firstDirection,
    XYZ secondDirection )
  {
    return ( ToleranceConstants.AreEqual( Math.Abs( firstDirection.X ),
  ...
  {
    return ToleranceConstants.AreEqual( direction.Normalize()
        .Z,
      XYZ.BasisZ.Z ) ;
  }
  ...
  public static bool IsOppositeDirection( this XYZ direction1,
    XYZ direction2 )
  {
    return Math.Abs( direction1.X - direction2.X ) < ToleranceConstants.GeneralTolerance
