...
public static class CurveExtensions
{
    ...
    ///     Two curves are parallel when the angle between them is 0 or 180 degrees and the distance between them is greater
    ///     than 0.
    /// </summary>
    /// <param name="curve1">The first curve.</param>
    /// <param name="curve2">The second curve.</param>
    ...
    public static XYZ GetNormalBetweenParallelCurves(this Curve curve,
        Curve otherCurve) =>
        otherCurve.ProjectionOf(curve.GetEndPoint(0))
    ...
    /// <throws cref="NotImplementedException">
    ///     If the
    ///     curve type is not supported by this utility.
    /// </throws>
        ...
        if (curve is Line line)
        {
            XYZ strPoint = new(line.GetEndPoint(0)
                ...
                line.GetEndPoint(0)
                    .Y,
                elevation) ;
            XYZ endPoint = new(line.GetEndPoint(1)
                    .X,
                line.GetEndPoint(1)
                    .Y,
                elevation) ;
